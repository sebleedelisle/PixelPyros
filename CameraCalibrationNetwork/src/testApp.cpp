...
void testApp::setup() {
	...
	//cam.setup("network cam", 1280, 720, 30, "http://"+camera1Address+"/axis-cgi/mjpg/video.cgi?resolution=1280x720", "root", "password");
	
	string url = "http://10.0.1.31/axis-cgi/mjpg/video.cgi?resolution=1280x720";
	string user = "root";
	string password = "password";
	string name = "network cam";
	
    cam.setUsername(user);
